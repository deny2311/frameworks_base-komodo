package com.komodo.systemui.keyguard;
...
public class KomodoKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KomodoKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KomodoKeyguardSliceProvider keyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            KomodoKeyguardSliceProvider keyguardSliceProvider;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProvider = (KomodoKeyguardSliceProvider) mProviderReference.get();
            }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KomodoKeyguardSliceProvider#onBindSlice");
        Slice slice;
